...
```{r}
var1 <- na.omit(dataFlight[dataFlight$origin == "JFK",]$air_time)
var2 <- na.omit(dataFlight[dataFlight$origin == "EWR",]$air_time)
var3 <- na.omit(dataFlight[dataFlight$origin == "LGA",]$air_time)
length(var1)
length(var2)
length(var3)
frecuenciasEmpiricas <- c(var1,var2,var3)
stats::chisq.test(frecuenciasEmpiricas)
```

```{r}
var2 <- na.omit(dataFlight[dataFlight$origin == "LGA",]$air_time)
length(var2)
prom <- mean(var2)
prom
varianza <- sd(var2)
varianza
freq1 <- length(which(var2 < 100))
freq2 <- length(which(var2 <= 100& var2< 120)) 
freq3 <- length(which(var2 <=120 &var2 < 140)) 
freq4 <- length(which(var2 <= 140 & var2 < 160)) 
freq5 <- length(which(var2 <= 160 & var2 < 180))
freq6 <- length(which( var2 >= 180))
freq1
freq2
freq3
freq4
...
extremos.izquierdos <- c(-Inf, 100, 120, 140, 160,180)
extremos.derechos <- c(100, 120, 140, 160,180, Inf)
frecuencias.empiricas <- c(freq1, freq2, freq3, freq4, freq5,freq6)
probabilidades.teoricas <- pnorm(extremos.derechos, prom, varianza^2) - pnorm(extremos.izquierdos, prom, varianza^2)
chisq.test(frecuencias.empiricas, p = probabilidades.teoricas)
plot(density(var2), main="Estimación de la densidad")
```
- \n
### **Prueba de independencia**
```{r}
var1 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Very Good" & dataDiamonds$clarity=="VVS2",]$cut)
length(var1)
var2 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Good" & dataDiamonds$clarity=="SI2",]$cut)
length(var2)
var3 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Ideal" & dataDiamonds$clarity=="VS1",]$cut)
length(var3)
var4 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Very Good" & dataDiamonds$clarity=="SI2",]$cut)
length(var4)
var5 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Good" & dataDiamonds$clarity=="VS1",]$cut)
length(var5)
var6 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Ideal" & dataDiamonds$clarity=="VVS2",]$cut)
length(var6)
var7 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Very Good" & dataDiamonds$clarity=="VS1",]$cut)
length(var7)
var8 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Good" & dataDiamonds$clarity=="VVS2",]$cut)
length(var8)
var9 <- na.omit(dataDiamonds[dataDiamonds$color == "J" & dataDiamonds$cut == "Ideal" & dataDiamonds$clarity=="SI2",]$cut)
length(var9)
chisq.test(matrix(c(var1,var2,var3,var4,var5,var6,var7,var8,var9)),correct = T)
```
